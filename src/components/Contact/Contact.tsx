...
const contactInfo = [
  { icon: <Phone size={18} className="text-white" />, title: "Call Us", detail: "+91 98765 43210\nMon–Fri 9am–6pm" },
  { icon: <Mail size={18} className="text-white" />, title: "Email Us", detail: "hello@bestgiftever.com\n24/7 Support" },
  { icon: <MapPin size={18} className="text-white" />, title: "Visit Studio", detail: "456 Gift Street, Mumbai\nIndia" },
  { icon: <Headphones size={18} className="text-white" />, title: "Live Chat", detail: "Chat with us\nDaily 9am–8pm" },
];

const faqs = [
  { question: "What are your shipping options?", answer: "Standard (3–6 days) and express (2–3 days). Free shipping above ₹499." },
  { question: "Can I track my order?", answer: "Yes, you’ll receive a tracking link via email/SMS after dispatch." },
  { question: "What’s your return policy?", answer: "7-day replacement for defects. Easy returns for non-custom items." },
  { question: "Do you offer bulk discounts?", answer: "Yes, contact us for customized bulk pricing and branding." },
  { question: "Can I modify my order?", answer: "Within 24 hours of placement. After dispatch, returns policy applies." },
];
    ...
    <main className="min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-blue-50">
      ...
      <section className="relative text-white py-12 sm:py-14 md:py-16 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          <h1 className={cn([integralCF.className, "text-3xl sm:text-4xl md:text-5xl uppercase"])}>
            Contact Us
          </h1>
          <p className="text-white/90 mt-2 text-sm sm:text-base max-w-3xl">
            We’re here to help — orders, personalization, bulk gifting or anything else. Say hello!
          </p>
        </div>
      </section>

      {/* Contact Cards — themed like About */}
      ...
      {/* Main Contact Section — same structure, themed */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="personalize">Personalization</option>
            ...
            <motion.div initial={{ x: 50, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="lg:pl-8">
              ...
              <div className="space-y-6 mb-10">
                ...
                <InfoRow icon={<Phone size={20} className="text-white" />} title="Call Us" detail={"Customer Service: +91 98765 43210\nBulk Orders: +91 98765 43211"} />
                <InfoRow icon={<Mail size={20} className="text-white" />} title="Email Us" detail={"General: hello@bestgiftever.com\nSupport: support@bestgiftever.com"} />
                <InfoRow icon={<Clock size={20} className="text-white" />} title="Business Hours" detail={"Mon–Fri: 9:00 AM–8:00 PM\nSat: 10:00 AM–6:00 PM\nSun: 11:00 AM–5:00 PM"} />
              </div>
      ...
      <section className="py-12 md:py-16 bg-gradient-to-b from-white to-pink-50/60">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <motion.div initial={{ y: 50, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.2, duration: 0.6 }} className="max-w-3xl mx-auto">
...
const socialLinks = [
  { name: "Facebook", url: "https://facebook.com", icon: <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg> },
  { name: "Twitter", url: "https://twitter.com", icon: <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/></svg> },
  { name: "Instagram", url: "https://instagram.com", icon: <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zM5.838 12a6.162 6.162 0 1112.324 0 6.162 6.162 0 01-12.324 0zM12 16a4 4 0 110-8 4 4 0 010 8zm4.965-10.405a1.44 1.44 0 112.881.001 1.44 1.44 0 01-2.881-.001z"/></svg> },
