...
const WhyChooseUs = () => {
  ...
  return (
    <section className="relative py-12 sm:py-16 lg:py-20 overflow-hidden">
      {/* Background Pattern */}
      <div className="absolute inset-0 bg-gradient-to-br from-gray-50 via-white to-pink-50 -z-10" />
      <div className="absolute top-0 left-1/4 w-96 h-96 bg-purple-200/30 rounded-full blur-3xl -z-10" />
      <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-pink-200/30 rounded-full blur-3xl -z-10" />
      ...
      <div className="max-w-frame mx-auto px-4 xl:px-0">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-gift-pink to-gift-purple text-white px-6 py-2 rounded-full mb-4">
