...
const Header = () => {
  return (
    <header className="bg-[#FFF8F0] pt-10 md:pt-24 overflow-hidden">
      <div className="md:max-w-frame mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
        ...
        <section className="max-w-frame px-4">
          ...
          >
            LIGHT UP YOUR SPACE WITH OUR CANDLES
          </motion.h2>
          <motion.p
            ...
            className="text-black/70 text-sm lg:text-base mb-6 lg:mb-8 max-w-[545px]"
          >
            Discover a curated collection of premium scented and decorative candles that create warmth, ambiance, and a touch of elegance in every corner of your home.
          </motion.p>
          <motion.div
            initial={{ y: "100px", opacity: 0 }}
            whileInView={{ y: "0", opacity: 1 }}
        ...
        <motion.section
          ...
          className="relative md:px-4 min-h-[448px] md:min-h-[428px] bg-cover bg-top xl:bg-[center_top_-1.6rem] bg-no-repeat bg-[url('/images/candle11.png')] md:bg-[url('/images/candle19.png')]"
        >
          <Image
            priority
