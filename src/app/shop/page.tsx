      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        {categories.length > 0 ? (
                ...
                >
                  ...
                  <div className="flex flex-col flex-1 p-6 text-center bg-gradient-to-b from-white to-pink-50/30">
                    ...
                    <div className="flex-1">
                      <h3 className="text-xl font-bold mb-2 h-7 overflow-hidden font-bold text-gray-900  transition-all line-clamp-1">
                        {category.name}
                      </h3>
                    ...
                    <div className="pt-3 border-t-2 border-pink-100">
                      <div className="inline-flex items-center gap-2 text-sm font-semibold font-bold bg-rose-500 bg-clip-text text-transparent">
          ...
          <div className="text-center py-20 bg-white rounded-3xl shadow-lg">
            ...
            <p className="text-2xl font-bold font-bold bg-rose-500 bg-clip-text text-transparent mb-4">No categories available yet</p>
